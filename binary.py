...
strings = "abcdefghijklmnopqrstuvwxyz0123456789@#₹_&-+()/*!?~`|•°=∆¶$%✓"  # ne pas changer svp
...
def kramer(content: str, key: int) -> str:
    ...
    _names_ = ["_eval", "_exec", "_byte", "_bytes", "_bit", "_bits", "_system", "_encode", "_decode", "_delete", "_exit", "_Hacker", "_SM9"]
...
def main():
    ...
    print(Colorate.Diagonal(Colors.red_to_yellow, f"""Crypting with HackerSM9...
Using key {key}...
Encoding in ASCII...
